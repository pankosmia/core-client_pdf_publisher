...
export function WrapperTemplate({
  ...
  useEffect(() => {
    ...
    const initSortableList = (e) => {
      ...
      const draggingItem = document.querySelector(`.${itemClassName}.dragging`);
      if (!draggingItem) {
        return;
      }
      const siblings = [
              ...
              <Button
                ...
                onClick={() => {
                  changePrintOrder((prev) => {
                    const t = [...prev];
                    t.splice(t.indexOf(parseInt(keyWrapper, 10)), 1);
                    return t;
                  });
                  ...
                  changePrintData((prev) => {
                    ...
                    delete updatedSelected[parseInt(keyWrapper, 10)];
            ...
            >
              ...
              >
                <AccordionPicker
                  ...
                  removeButton={
                    advanceMode &&
                    Object.keys(JSON.parse(sections)).length > 1 ? (
                      <Button
                        onClick={() => {
